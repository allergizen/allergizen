...
exports.defaultTheme = exports.darkTheme = void 0;
...
const defaultTheme = {
  colorScheme: 'light',
  elevations: {
    0: _reactNative.Platform.select({
      android: {
        elevation: 0
      },
      default: {
    ...
    1: _reactNative.Platform.select({
      android: {
        elevation: 1
      },
      default: {
    ...
    2: _reactNative.Platform.select({
      android: {
        elevation: 2
      },
      default: {
    ...
    3: _reactNative.Platform.select({
      android: {
        elevation: 3
      },
      default: {
    ...
    4: _reactNative.Platform.select({
      android: {
        elevation: 4
      },
      default: {
    ...
    5: _reactNative.Platform.select({
      android: {
        elevation: 5
      },
      default: {
    ...
    6: _reactNative.Platform.select({
      android: {
        elevation: 6
      },
      default: {
    ...
    7: _reactNative.Platform.select({
      android: {
        elevation: 7
      },
      default: {
    ...
    8: _reactNative.Platform.select({
      android: {
        elevation: 8
      },
      default: {
    ...
    9: _reactNative.Platform.select({
      android: {
        elevation: 9
      },
      default: {
    ...
    10: _reactNative.Platform.select({
      android: {
        elevation: 10
      },
      default: {
    ...
    11: _reactNative.Platform.select({
      android: {
        elevation: 11
      },
      default: {
    ...
    12: _reactNative.Platform.select({
      android: {
        elevation: 12
      },
      default: {
    ...
    13: _reactNative.Platform.select({
      android: {
        elevation: 13
      },
      default: {
    ...
    14: _reactNative.Platform.select({
      android: {
        elevation: 14
      },
      default: {
    ...
    15: _reactNative.Platform.select({
      android: {
        elevation: 15
      },
      default: {
    ...
    16: _reactNative.Platform.select({
      android: {
        elevation: 16
      },
      default: {
    ...
    17: _reactNative.Platform.select({
      android: {
        elevation: 17
      },
      default: {
    ...
    18: _reactNative.Platform.select({
      android: {
        elevation: 18
      },
      default: {
    ...
    19: _reactNative.Platform.select({
      android: {
        elevation: 19
      },
      default: {
    ...
    20: _reactNative.Platform.select({
      android: {
        elevation: 20
      },
      default: {
    ...
    21: _reactNative.Platform.select({
      android: {
        elevation: 21
      },
      default: {
    ...
    22: _reactNative.Platform.select({
      android: {
        elevation: 22
      },
      default: {
    ...
    23: _reactNative.Platform.select({
      android: {
        elevation: 23
      },
      default: {
    ...
    24: _reactNative.Platform.select({
      android: {
        elevation: 24
      },
      default: {
